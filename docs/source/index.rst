...
Ambit Insights - Provides network metrics and threat visibility.

Ambit Management Console - A central application for managing agents.


Check out the :doc:`agent` section for further information on the agent.
